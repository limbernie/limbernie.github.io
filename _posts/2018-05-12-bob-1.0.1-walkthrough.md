...
last_modified_at: 2018-06-27 11:01:20 +0000
...
Otherwise, there's nothing interesting with these files except for—`dev_shell.php`. It exposes a web shell, the first attack surface, and this is how it looks like in the browser.
...
Because the output of this step ends up in file redirection, you don't see anything visible in the web shell. You can use `md5sum` for verification on your attacking machine and in the web shell—to ensure the integrity of the reverse shell is intact and unmodified.

...
<a class="image-popup">
![c12f044f.png](/assets/images/posts/registry-htb-walkthrough/c12f044f.png)
</a>
...
<a class="image-popup">
![1f298100.png](/assets/images/posts/registry-htb-walkthrough/1f298100.png)
</a>

And the password (`GkOcz221Ftb3ugog`) to unlock the private key.

<a class="image-popup">
![0191d3ac.png](/assets/images/posts/registry-htb-walkthrough/0191d3ac.png)
</a>
...
<a class="image-popup">
![f3861115.png](/assets/images/posts/registry-htb-walkthrough/f3861115.png)
</a>

Looks like someone got there before I did. :laughing:

<a class="image-popup">
![d9f3bbd8.png](/assets/images/posts/registry-htb-walkthrough/d9f3bbd8.png)
</a>
...
<a class="image-popup">
![5e25a2fd.png](/assets/images/posts/registry-htb-walkthrough/5e25a2fd.png)
</a>

Sending the hash to John the Ripper reveals the password (`strawbery`).

<a class="image-popup">
![b6f7539f.png](/assets/images/posts/registry-htb-walkthrough/b6f7539f.png)
</a>

Armed with `admin`'s password, I can log in to the Bolt CMS admin page at `/bolt/bolt`.

<a class="image-popup">
![0d790da3.png](/assets/images/posts/registry-htb-walkthrough/0d790da3.png)
</a>
...
<a class="image-popup">
![63ad602d.png](/assets/images/posts/registry-htb-walkthrough/63ad602d.png)
</a>

<a class="image-popup">
![747b576a.png](/assets/images/posts/registry-htb-walkthrough/747b576a.png)
</a>

<a class="image-popup">
![062e2e1e.png](/assets/images/posts/registry-htb-walkthrough/062e2e1e.png)
</a>
...
<a class="image-popup">
![df382c3e.png](/assets/images/posts/registry-htb-walkthrough/df382c3e.png)
</a>
...
<a class="image-popup">
![c5bdf14b.png](/assets/images/posts/registry-htb-walkthrough/c5bdf14b.png)
</a>

Looks like `www-data` has the permission to do something as `root` without password!

<a class="image-popup">
![695626fc.png](/assets/images/posts/registry-htb-walkthrough/695626fc.png)
</a>
...
<a class="image-popup">
![6908582f.png](/assets/images/posts/registry-htb-walkthrough/6908582f.png)
</a>
...
<a class="image-popup">
![5ef72a60.png](/assets/images/posts/registry-htb-walkthrough/5ef72a60.png)
</a>
...
<a class="image-popup">
![ce96f344.png](/assets/images/posts/registry-htb-walkthrough/ce96f344.png)
</a>

On my machine, I can dump `root.txt` from the latest snapshot.

<a class="image-popup">
![1ecffee2.png](/assets/images/posts/registry-htb-walkthrough/1ecffee2.png)
</a>
